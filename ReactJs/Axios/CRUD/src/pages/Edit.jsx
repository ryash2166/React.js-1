      ...
      <form className="bg-white p-6 rounded shadow-md w-full max-w-sm" onSubmit={formik.handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <div className='flex justify-center'>
            <button type="Submit" className="px-[16px] mr-3 rounded-lg hover:rounded-xl py-[10px] bg-gray-800 mt-2 border-[1px] border-black text-white hover:bg-white hover:text-black duration-300 ease-in-out hover:scale-105 font-[500]">Edit User</button>
